...
{cyan}oo______oo_ooo____oo_oooo_oo____oo_
...
'password':pwd}
    ...
    def main():
        ...
        print(f"{purple}[{yellow}2{purple}]{off} UGM ")
        print(f"{purple}[{yellow}3{purple}]{off} UNSYIAH ")
        print(f"{purple}[{yellow}4{purple}]{off} UNUSA ")
        print(f"{purple}[{yellow}5{purple}]{off} USD ")
        print(f"{purple}[{yellow}6{purple}]{off} UNSRAT ")
        print(f"{purple}[{yellow}7{purple}]{off} UPI ")
        print(f"{purple}[{yellow}8{purple}]{off} UAJY ")
        print(f"{purple}[{yellow}9{purple}]{off} UB ")
        print(f"{purple}[{yellow}10{purple}]{off} ITB ")
        print(f"{yellow}[{cyan}11{yellow}]{off} {green}Bonus{off} forlap dumper")
        select = input(f"\n{purple}[{yellow}?{purple}]{off} Pilih > ")
        if select == '1':
            uiip()
        elif select == '2':
            ugmp()
